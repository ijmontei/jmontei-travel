...
function ItineraryPanel({ posts }: { posts: Post[] }) {
  ...
  return (
    // ✅ 1) Tinted canvas (reduces “white slabs” feeling)
    <section className="mt-6 rounded-3xl border bg-gradient-to-b from-zinc-50 via-white to-zinc-50/60 p-4 sm:p-5">
          ...
          {grouped.map((cg, cIdx) => {
            ...
            return (
              <div key={`country-${cg.country}`} className="space-y-3">
                ...
                <details className="group rounded-2xl border bg-white/55 backdrop-blur shadow-sm overflow-hidden">
                    ...
                    {cg.cities.map((cityGroup, cityIdx) => {
                      ...
                      return (
                        <div key={`city-${cg.country}-${cityGroup.city}`} className="space-y-3">
                          ...
                          <details className="group/city rounded-2xl border bg-white/55 backdrop-blur shadow-sm overflow-hidden">
                                    ...
                                    <div className="space-y-3">
                                      {accGroups.map(({ acc, posts }, gi) => {
                                        ...
                                        return (
                                          ...
                                          <div
                                            key={`acc-group-${gi}`}
                                            className="relative overflow-hidden rounded-2xl bg-white/60 shadow-sm ring-1 ring-black/5"
                                          >
                                            <div
